...
# --- GRAFICO 1: CONDUCENTI ---
sns.lineplot(data=df_plot_feriti_conducenti, x='anno', y='feriti_conducenti', hue='causa', marker='o', palette=CAUSE_PALETTE, ax=axes[0], linewidth=2.5)
...
# --- GRAFICO 2: TRASPORTATI ---
sns.lineplot(data=df_plot_feriti_trasportati, x='anno', y='feriti_trasportati', hue='causa', marker='o', palette=CAUSE_PALETTE, ax=axes[1], linewidth=2.5)
...
sns.lineplot(data=df_plot_feriti_pedoni, x='anno', y='feriti_pedoni', hue='causa', marker='o', palette=CAUSE_PALETTE, ax=axes[2], linewidth=2.5)
...
# --- GRAFICO 1: CONDUCENTI ---
sns.lineplot(data=df_plot_morti_conducenti, x='anno', y='tasso_conducenti', hue='causa', marker='o', palette=CAUSE_PALETTE, ax=axes[0], linewidth=2.5)
...
# --- GRAFICO 2: TRASPORTATI ---
sns.lineplot(data=df_plot_morti_trasportati, x='anno', y='tasso_trasportati', hue='causa', marker='o', palette=CAUSE_PALETTE, ax=axes[1], linewidth=2.5)
...
# --- GRAFICO 3: PEDONI ---
sns.lineplot(data=df_plot_morti_pedoni, x='anno', y='tasso_pedoni', hue='causa', marker='o', palette=CAUSE_PALETTE, ax=axes[2], linewidth=2.5)
